...
export function OperationContextProvider ({ children }){
    ...
    useEffect( function(){
        fetch("http://localhost:4201/operations")
    ...
    function add(item){
        ...
        fetch("http://localhost:4201/operations" , options )
            .then(function(reponse){return reponse.json()})
            .then(function(data){ 
    ...
    function supprimer (ope){
        ...
        fetch(`http://localhost:4201/operations/${ope.id}`, options)
            .then(function(reponse){ return reponse.json()})
            .then(function(){
    ...
    fetch(`http://localhost:4201/operations/${item.id}` , options )
        .then(function(reponse){return reponse.json()})
        .then(function(){ 
            const cloneOperation = structuredClone(operations)
